<template>
  <AdminNavigation>
    <v-container class="">
      <v-row>
        <v-col>
          <div class="display-1" v-text="'Edit ' + product.title"></div>
        </v-col>
      </v-row>
      <v-row>
        <v-col sm="4" cols="12" class="">
          <v-row dense>
            ...
            <v-col cols="12">
              ...
              <label for="">Update image 4</label>
              <v-file-input
                type="file"
                outlined
                :loading="loading"
            ...
            <v-col cols="12">
              ...
              <label for="">Update image 5</label>
              <v-file-input
                type="file"
                outlined
                dense
...
export default {
  ...
  methods: {
    update() {
      Inertia.post(`/admin/products/update/${this.product.id}`, this.form, {
        forceFormData: true,
        preserveScroll: true,
        preserveState: true,
        onStart: () => {
          ...
          this.text = "Product update in progress, please wait...";
        },
        onSuccess: () => {
          this.timeout = 3000;
